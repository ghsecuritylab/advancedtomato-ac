...
<form id="_fom" method="post" action="tomato.cgi">
	...
	<div class="section" id="sesdiv_settings">
		<script type="text/javascript">
			...
			], '#sesdiv_settings', 'fields-table');
		</script>
	</div>

	<h3>PPTP User List <small><i><a href="javascript:toggleVisibility('userlist');"><span id="sesdiv_userlist_showhide"><i class="icon-chevron-down"></i></span></a></i></small></h3>
