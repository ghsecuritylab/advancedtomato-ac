...
<content>
	...
	<script type="text/javascript">
		if (nvram.cstats_enable != '1') {
			$('#cstats').before('<div class="alert info">IP Traffic monitoring disabled.</b> <a href="admin-iptraffic.asp">Enable &raquo;</a></div><br />');
	...
	<div class="spinner" id="refresh-spinner" onclick="javascript:debugTime=1"></div><span id="dtime"></span>
	<div class="alert" id="warnwd" style="display:none">Warning: 10 second timeout, restarting...&nbsp;</div>
