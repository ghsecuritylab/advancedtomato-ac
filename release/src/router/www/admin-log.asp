	...
	<div class="section settings">
		<script type="text/javascript">
			...
			createFieldTable('', [
				...
				{ title: 'Custom Log Path & Filename', help: 'Make sure the directory exists and is writable', multi: [
					{ name: 'f_log_file_custom', type: 'checkbox', value: nvram.log_file_custom == 1, suffix: '  ' },
					{ name: 'log_file_path', type: 'text', maxlen: 32, size: 20, value: nvram.log_file_path }
				] },
			...
			], '.section.settings', 'fields-table');
		</script>
	</div>

	<h3>Web Monitor</h3>
	<div class="section webmon">
		<script type='text/javascript'>
			createFieldTable('', [
				...
				{ title: 'IP Address(es)', indent: 2,  name: 'f_log_wmip', type: 'text', maxlen: 512, size: 48, value: nvram.log_wmip,
				...
				{ title: 'Daily Backup', name: 'f_webmon_bkp', type: 'checkbox', value: nvram.webmon_bkp == 1, help: 'Creates backup every day at midnight.' },
				{ title: 'Clear Data After Backup', indent: 2, name: 'f_webmon_shrink', type: 'checkbox', value: nvram.webmon_shrink == 1 },
				{ title: 'Backup Directory', indent: 2,  name: 'webmon_dir', type: 'text', maxlen: 128, size: 30, value: nvram.webmon_dir, help: 'Make sure the directory exists and is writable' }
			], '.section.webmon', 'fields-table');
		</script>
	</div>
