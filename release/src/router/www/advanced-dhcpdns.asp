...
<content>
	<script type="text/javascript">
		//	<% nvram("at_update,tomatoanon_answer,dhcpd_dmdns,dns_addget,dhcpd_gwmode,dns_intcpt,dhcpd_slt,dhcpc_minpkt,dnsmasq_custom,dnsmasq_norw,dhcpd_lmax,dhcpc_custom,dns_norebind,dhcpd_static_only"); %>
		...
		<div class="section dnsdhcp">
			<script type="text/javascript">
				createFieldTable('', [
					...
					{ title: 'Intercept DNS port <b>(UDP 53)</b>', name: 'f_dns_intcpt', type: 'checkbox', value: nvram.dns_intcpt == '1' },
		...
		<div class="section dhcpwan">
			<script type="text/javascript">
				createFieldTable('', [
					...
					], '.dhcpwan', 'fields-table');
			</script>
		</div>

		<h3>Notes <small><i><a href="javascript:toggleVisibility('notes');"><span id="sesdivnotesshowhide"><i class="icon-chevron-up"></i></span></a></i></small></h3>
