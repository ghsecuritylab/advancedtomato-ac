<title>About</title>
<content>
	<h3>Tomato Firmware <% version(1); %></h3>
	<!-- USB-BEGIN -->
	...
	<!-- OPENVPN-BEGIN -->
	<h4>OpenVPN integration and GUI</h4>
	Copyright (C) 2010 Keith Moyer,<br>
	<a href='mailto:tomatovpn@keithmoyer.com'>tomatovpn@keithmoyer.com</a><br>
	<br>
	<!-- OPENVPN-END -->

	<h4>"Shibby" features:</h4>
	<!-- BBT-BEGIN -->
	...
	<h3>"Victek/PrinceAMD/Phykris/Shibby" feature:</h3>
	- Revised IP/MAC Bandwidth Limiter<br>
	<br>
	<br>
	Built on <% build_time(); %> by Jacky, <a href='http://at.prahec.com/' target='_new'>http://at.prahec.com/</a>
	<span style="font-size:12px;"><br />
		<b>Thanks to everyone who risked their routers, tested, reported bugs, made
			suggestions and contributed to this project. ^ _ ^</b><br><br>
	</span>

	<!-- Please do not remove or change the homepage link or donate button. Thanks. - Jon -->
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
		<input type="hidden" name="cmd" value="_s-xclick">
		<button class="btn btn-primary" value="submit" border="0" name="submit" alt="Donate">Donate</button>
		...
		<span style="color: red;"><br /><br />Note: These donations go directly to original Tomato developer.<br /> 
			If you wish to donate towards AdvancedTomato check <a href="http://at.prahec.com/donate/" target="_blank">http://at.prahec.com/donate/</a>!</span>
	</form>
