...
--><title>Dynamic DNS</title><content>
	...
	<script type="text/javascript">
		...
		for (i = 0; i < 2; ++i) {
			...
			$write = ('<h3>Dynamic DNS ' + (i + 1) + '</h3><div class="section">');
			$write = createFieldTable('', [
