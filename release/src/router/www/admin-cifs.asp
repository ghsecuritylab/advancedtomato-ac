...
<content>
	...
	<div class="section" id="mounties">
		<script type="text/javascript">
			...
			createFieldTable('', [
				{ title: '<h3><i class="icon-drive"></i> /cifs1</h3>' },
				...
				], '#mounties', 'fields-table');

			createFieldTable('', [
				{ title: '<h3><i class="icon-drive"></i> /cifs2</h3>' },
	...
	<br /><script type="text/javascript">show_notice1('<% notice("cifs"); %>');</script>
