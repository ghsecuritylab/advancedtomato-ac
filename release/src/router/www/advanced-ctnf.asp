		...
		<script type="text/javascript">
			...
			<div class="section tcptimeout">
				<script type="text/javascript">
					...
					createFieldTable('', f, '.section.tcptimeout', 'fields-table');
				</script>
			</div>

			<h3>UDP Timeout</h3>
			<div class="section udptimeout">
				<script type="text/javascript">
					...
					], '.section.udptimeout', 'fields-table');
				</script>
			</div>

			<h3>Other Timeouts</h3>
			<div class="section otimeout">
				<script type="text/javascript">
