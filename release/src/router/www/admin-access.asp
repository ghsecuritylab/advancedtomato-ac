...
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="section GUI">
			<script type="text/javascript">
				var m = [
					...
					{ title: '<b>SSL Certificate</b>', rid: 'row_sslcert' },
					...
					{ title: 'Color Scheme', name: 'web_css', type: 'select',
						options: [['tomato','Default Theme'],['ext/custom','Custom (ext/custom.css)'], ['online', 'On-line from ATTD']], value: nvram.web_css },
					...
					{ title: 'Interface Width (<i class="icon-info tooltip icon-normal" data-info="This preference allows you to change the way web interface adapts to your browser screen."></i>)', size: 35, 
		...
		<div class="section SSH">
			<script type="text/javascript">
				createFieldTable('', [
					...
					{ title: 'Authorized Keys', name: 'sshd_authkeys', type: 'textarea', style: 'width: 100%; height: 150px;', value: nvram.sshd_authkeys }
		...
		<button type="button" value="Save" id="save-button" onclick="save(); alert('yo!');" class="btn btn-primary">Save <i class="icon-check"></i></button>
