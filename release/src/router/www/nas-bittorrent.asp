...
<content>
	...
	<h3>Remote Access <script>W(btgui_link);</script></h3>
	<div class="section">
		<div class="remoteacc"></div>
		<script type="text/javascript">
			createFieldTable('', [
	...
	<div class="section">
		...
		<script type="text/javascript">
			createFieldTable('', [
				...
				], '.limitsgui', 'fields-table');
		</script>
	</div>

	<h3>Queue torrents</h3>
	<div class="section">
		<div class="queuetor"></div>
		<script type="text/javascript">
			createFieldTable('', [
